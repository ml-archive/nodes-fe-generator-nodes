...
Creates a module and an animation

From the command line the following options are available:

`--skip-module` - Skips creating a module file. Use this if the animation is part of another module.
...
* `moduleType` - Allows other subgenerators to provide the root folder in which the animation should be created in
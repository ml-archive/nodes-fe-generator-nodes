...
module.exports = nodesGenerator.extend({
	...
	constructor: function() {
		...
		this.option('skip-module', {
			desc: 'Skips registerring the route as a standalone angular module',
			type: Boolean
		});
	...
	prompting: {
		...
		promptForModuleLocation: function() {
			...
			var prompt = {
				type: 'input',
				name: 'location',
				message: chalk.green('Which folder should i create the route in?'),
				default: this.name
			};
